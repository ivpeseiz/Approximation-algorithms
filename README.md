...
Para el problema de la mochila, el formato de la instancia es una lista llamada items de la forma [(valor, peso)], es decir una lista de duplas donde el primer elemento del par es el valor del objeto en cuestión y el segundo elemento es su peso. Por otro lado, la capacidad de la mochila viene dado aparte, bien como parametro (en el caso del algoritmo genético), o bien en la misma llamada a la función mochila_FPTAS (en el caso del algoritmo de aproximación FPTAS)
